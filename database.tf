...
#   name       = "gastroman-db-subnet-group-${local.environment}"
...
#   identifier = "gastroman-mariadb-${local.environment}"
...
#   final_snapshot_identifier = "gastroman-mariadb-${local.environment}-final"
